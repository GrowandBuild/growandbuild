            ...
            <div class="header-content">
                <div class="header-left">
                    ...
                    <div class="header-title">
                        ...
                        <p class="header-subtitle">Atualize informações da categoria</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   class="w-5 h-5 rounded border-white/20 bg-white/10 text-emerald-500 focus:ring-emerald-500">
                            <span class="text-sm font-medium text-white/90">Categoria Ativa</span>
                        </label>
                        <small class="text-white/60 text-xs">
                            Categorias inativas não aparecerão nas sugestões de autocomplete
                        </small>
                    </div>
                    ...
                    <div class="bg-white/5 rounded-lg p-4 space-y-2">
                        <div class="flex justify-between">
                            <span class="text-white/60 text-sm">Produtos nesta categoria:</span>
                            <span class="text-white font-semibold">{{ $productCategory->products_count ?? 0 }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-white/60 text-sm">Total de usos:</span>
                            <span class="text-white font-semibold">{{ $productCategory->usage_count }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-white/60 text-sm">Nome normalizado:</span>
                            <span class="text-white/80 text-sm font-mono">{{ $productCategory->normalized_name }}</span>
                        </div>
                    </div>
                </div>
            </div>
